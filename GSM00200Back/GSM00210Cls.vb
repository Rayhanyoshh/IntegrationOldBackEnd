    ...
    Protected Overrides Sub R_Saving(poNewEntity As GSM00210DTO, poCRUDMode As eCRUDMode)
        ...
        Try
            ...
            ElseIf poCRUDMode = eCRUDMode.EditMode Then
                ...
                lcQuery = String.Format(lcQuery, poNewEntity.LAUDIT_ENABLE, poNewEntity.CUSER_ID, _GetDate(poNewEntity.DDATE),
            ...
            lcQuery = String.Format(lcQuery, IIf(loResult IsNot Nothing, 1, 0), poNewEntity.CUSER_ID, _GetDate(poNewEntity.DDATE),
